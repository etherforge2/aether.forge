...
const PLANS = [
  {
    ...
    monthlyMid: 1.6,
    color: "#A8B2C1",
    features: ["Basic AI Trading", "Email Support", "Monthly Settlement", "Target Range Reports"],
  },
  {
    id: "gold",
    name: "Gold",
    ...
    monthlyMid: 2.3,
    color: "#C9A84C",
    features: ["Advanced AI Trading", "Priority Support", "Monthly Settlement", "Market Insights"],
  },
  {
    id: "platinum",
    name: "Platinum",
    ...
    monthlyMid: 2.85,
    color: "#A0C4FF",
    features: ["Premium AI Suite", "24/7 Support", "Monthly Settlement", "Real-time Analytics", "Dedicated Manager"],
  },
  {
    id: "diamond",
    name: "Diamond",
    ...
    monthlyMid: 3.2,
    color: "#B9F2FF",
    features: ["Elite AI Trading", "VIP Support", "Monthly Settlement", "Private Signals", "Account Manager"],
  },
  {
    id: "elite",
    name: "Elite",
    ...
    monthlyMid: 3.45,
    color: "#FF9CEE",
    features: ["Institutional Suite", "White-glove Support", "Monthly Settlement", "Exclusive Signals", "Senior Manager"],
  },
  {
    id: "vip",
    name: "VIP",
    ...
    monthlyMid: 3.7,
    color: "#00D4AA",
    features: ["Ultra AI Engine", "Dedicated Team", "Monthly Settlement", "Live Dashboard", "C-Suite Advisor"],
  },
  {
    id: "enterprise",
    name: "Enterprise",
    ...
    monthlyMid: 3.95,
    color: "#FFD700",
    features: ["Full HFT Access", "Private Desk", "Monthly Settlement", "OTC Trading", "Portfolio Rebalancing"],
  },
  {
    id: "sovereign",
    name: "Sovereign",
    ...
    monthlyMid: 4.15,
    color: "#FF6B6B",
    features: ["Sovereign Desk", "Personal Quant Support", "Monthly Settlement", "Multi-asset Exposure", "Family Office Support"],
  },
];
  ...
  {loading ? (
    ...
    <div style={{ ...S.glassCard, padding: 22 }}>
      ...
      {loading ? (
        ...
        transactions.map((tx) => (
          <div key={tx.id} style={{ display: "flex", justifyContent: "space-between", marginBottom: 14, paddingBottom: 14, borderBottom: "1px solid rgba(255,255,255,0.04)" }}>
            <div>
            ...
            <div style={{ color: tx.amount > 0 ? PALETTE.success : PALETTE.danger, fontWeight: 700 }}>
      ...
      <div style={{ maxWidth: 500, margin: "60px auto", padding: "0 16px", textAlign: "center" }}>
        <div style={{ ...S.glassCard, padding: isMobile ? 28 : 44 }}>
          ...
          <div style={{ color: PALETTE.textMuted, lineHeight: 1.7, marginBottom: 24, fontSize: 14 }}>
            ...
            <strong style={{ color: PALETTE.teal }}>{termMonths} months</strong> is pending confirmation. It will
  ...
  return (
    <div style={{ maxWidth: 900, margin: "0 auto", padding: isMobile ? "28px 16px" : "48px 24px" }}>
      <div style={{ marginBottom: 28 }}>
        ...
        <div style={{ color: PALETTE.textMuted, fontSize: 13 }}>Monthly AI settlement · term chosen by you.</div>
      </div>

      <div style={{ display: "grid", gridTemplateColumns: isMobile ? "1fr" : "1fr 1fr", gap: 20 }}>
        <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
          <div style={{ ...S.glassCard, padding: isMobile ? 20 : 24 }}>
            <div style={{ fontSize: 11, color: PALETTE.textMuted, fontWeight: 600, letterSpacing: "0.08em", textTransform: "uppercase", marginBottom: 12 }}>
              Selected Plan
            </div>
            ...
            <div style={{ marginTop: 14 }}>
              ...
              <div style={{ fontSize: 12, color: PALETTE.textMuted, marginTop: 6 }}>
                Target monthly range: {monthlyMin}% – {monthlyMax}%
              </div>
              {termMonths >= 18 && (
          ...
          <div style={{ ...S.glassCard, padding: isMobile ? 20 : 24 }}>
            <div style={{ fontSize: 11, color: PALETTE.textMuted, fontWeight: 600, letterSpacing: "0.08em", textTransform: "uppercase", marginBottom: 14 }}>
              Estimated Returns
            </div>
            {[
            ...
            <div style={{ fontSize: 11, color: PALETTE.textMuted, marginTop: 4 }}>
              Targets are potential ranges. Capital at risk. Early exit returns principal only.
            </div>
          </div>

          <div style={{ background: "rgba(201,168,76,0.08)", border: "1px solid rgba(201,168,76,0.25)", borderRadius: 12, padding: 14, fontSize: 12, color: PALETTE.gold, lineHeight: 1.7 }}>
            🔒 Lock period: Principal is committed for {termMonths} months. Early exit returns principal only; profit and bonuses are forfeited. Monthly AI settlement applies while active.
          </div>
        </div>
        ...
        <div style={{ ...S.glassCard, padding: isMobile ? 20 : 24 }}>
          ...
          <div style={{ background: "rgba(0,0,0,0.4)", borderRadius: 10, padding: "12px 14px", display: "flex", alignItems: "center", gap: 8, marginBottom: 14 }}>
            <span style={{ fontFamily: "monospace", fontSize: 10, color: PALETTE.textMuted, flex: 1, wordBreak: "break-all" }}>
              {selected.addr}
            </span>
